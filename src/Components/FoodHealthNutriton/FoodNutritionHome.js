...
function FoodHealthHome() {
    ...
    return (
        <>
            <Container className='div-center mt-4 mb-4'>
                <Row>
                    <Col xs={12} sm={12} md={12} lg={6} xl={6} className="d-flex align-items-center my-2">
                        <div className='mt-4 p-5 rounded bg-warning text-white d-flex flex-column justify-content-center align-items-center text-center food-container h-100'>
                            <h1 style={{ fontSize: "2rem", lineHeight: "2.5rem" }} className='text-center'>Food Health & Nutriton</h1>
                            <p style={{ fontSize: "1rem", lineHeight: "1.5rem" }} className='text-center text-wrap'>
                    ...
                    <Col xs={12} sm={12} md={6} lg={3} xl={3} className="d-flex align-items-center my-2">
                        <img style={{ objectFit: "contain", width: "100%", height: "100%" }} src="https://img.freepik.com/premium-photo/crossword-puzzle-pencil_488220-880.jpg?" alt="crossword" class="img-thumbnail img-fluid mt-4" />
                    </Col>
                    <Col xs={12} sm={12} md={6} lg={3} xl={3} className="d-flex align-items-center my-2">
                        <div className='mt-4 p-4 rounded bg-info text-white h-100'>
            ...
            <Container className='div-center mb-5'>
                <Row>
                    <Col xs={12} sm={12} md={6} lg={3} xl={3} className="d-flex align-items-center my-2">
                        <div className='mt-4 p-4 rounded bg-success text-white h-100'>
                    ...
                    <Col xs={12} sm={12} md={6} lg={3} xl={3} className="d-flex align-items-center my-2">
                        <img style={{ objectFit: "contain", width: "100%", height: "100%" }} src="https://img.freepik.com/free-vector/spelling-word-scramble-game-with-word-papaya_1308-40253.jpg?&t=st=1665996848~exp=1665997448~hmac=14fb356f9703722a57bb947f7fde90d6d402c940bb3444b139968ceab6e0853a" alt="crossword" class="img-thumbnail img-fluid mt-4" />
                    </Col>
                </Row>
            </Container>
        </>
