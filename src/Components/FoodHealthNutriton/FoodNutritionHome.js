          ...
          <Button variant="secondary" onClick={handleClose}>
            Got It
                    ...
                    {/* <Col xs={12} sm={12} md={12} lg={6} xl={6} className="d-flex justify-content-center">
                        <Col style={{ minHeight: "35vh", width: "50%" }} >
                            <img style={{ height: "35vh" }} src="https://img.freepik.com/premium-photo/crossword-puzzle-pencil_488220-880.jpg?" alt="crossword" class="img-thumbnail img-fluid mt-4" />
                        </Col>
                        <Col style={{ height: "35vh", width: "50%" }}>
                            <div className='mt-4 p-4 rounded bg-info text-white' style={{ height: "35vh" }}>
                                <h1 style={{ fontSize: "2rem"}}>Crossword</h1>
                ...
                <Row>
                    ...
                    {/* <Col xs={12} sm={12} md={12} lg={6} xl={6} className="d-flex justify-content-center">
                        <div style={{ height: "35vh", width: "50%" }}>
                            <div className='mt-4 p-4 rounded bg-primary text-white' style={{ height: "35vh" }}>
                                <h1 style={{ fontSize: "2rem"}}>Wordsearch</h1>
