...
import CarbohydrateItem from './CarbohydrateItem';


function CarbohydrateHome() {
    const gameItems = [
        {
            fid: 1,
        ...
        },
        {
            ...
            component: 'carbohydratecrossword'
        },
        {
            fid: 3,
    ...
    return (
        <>
            ...
            <Col xs={3} className="food-health-nutrion-item-container">
                <CarbohydrateItem data={gameItems} />
            </Col>
            </Container>
            </> 
    )
...
export default CarbohydrateHome;
